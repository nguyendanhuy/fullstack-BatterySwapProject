        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            : 'border-blue-300 bg-gradient-to-br from-blue-50 to-indigo-50'}`}>
                ...
                <Button onClick={handleScan} disabled={isScanning} className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl py-4 px-8 text-lg font-semibold transition-all duration-300 hover:scale-105 shadow-lg min-w-[250px]">
                  {isScanning ? (<>
          ...
          <div>
            {scannedCustomer ? (<Card className="border-0 shadow-xl bg-white/90 backdrop-blur-sm animate-scale-in">
            ...
            ].map((item, index) => (<div key={index} className="flex items-center space-x-4 p-4 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors">
              ...
              </Card>) : (<Card className="border-0 shadow-lg bg-white">
